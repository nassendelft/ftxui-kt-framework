...
publishing {
    publications.withType<MavenPublication>().all {
        ...
        pom {
            ...
            url.set("https://github.com/nassendelft/ftxui-kt-framework")
            ...
            scm {
                connection = "scm:git:git://github.com/nassendelft/ftxui-kt-framework.git"
                developerConnection = "scm:git:ssh://github.com/nassendelft/ftxui-kt-framework.git"
                url = "https://github.com/nassendelft/ftxui-kt-framework"
            }
        }
    }
}
...
publishing {
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/nassendelft/ftxui-kt-framework")
            credentials {
